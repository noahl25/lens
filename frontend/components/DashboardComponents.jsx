...
export default function DashboardComponents({ query }) {
    ...
    const getComponent = (component, key) => {
        return (
            <motion.div
                ...
                // make the grid cell a flex column and allow it to grow/shrink vertically
                className={`col-span-${component.cols} min-h-0 flex flex-col`}
            >
